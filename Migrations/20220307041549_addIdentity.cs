...
namespace R10_login_Identity.Migrations
{
    public partial class addIdentity : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            fakerArticle.RuleFor(a => a.Created, f => f.Date.Between(new DateTime(2000, 01, 01), new DateTime(2020, 12, 12)));
            fakerArticle.RuleFor(a => a.Content, f => f.Lorem.Paragraphs(1, 4));

            //fakerArticle.Generate(); //tao
            ...
            for (int i = 0; i < 100; i++)
            {
                var articles = fakerArticle.Generate();
                migrationBuilder.InsertData(
                    table: "Posts",
                    columns: new[] { "Title", "Created", "Content" },
                    values: new object[] {
